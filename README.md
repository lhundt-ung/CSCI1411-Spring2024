# Welcome to Spring 2024 CSCI1411: Script Programming Repository
...
```
git clone https://github.com/lhundt-ung/CSCI1411-Spring2024/
```
...
1. Launch your VM in VMware Player
2. Open a terminal window or IDE (Visual Studio Code, PowerShell ISE)
3. Change Directory (cd) to base of the repository folder (i.e WINDOWS: c:\users\administrator\CSCI1411-Spring2024 or KALI: /home/kali/CSCI1411-Spring2024)
